...
onEvent("recipes", event => {
    ...
    event.shaped(Item.of('mysticalagriculture:inferium_farmland'),
        ...
        E: 'woldvaults:vault_essence_block'
    })
    ...
    event.shaped(Item.of('woldvaults:pogging_seed_base'),
        [
            'EXE',
            'XVX',
            'EXE'
    ...
    event.shaped(Item.of('woldvaults:echoing_seed_base'),
        [
            'EXE',
            'XVX',
            'EXE'
        ], {
        V: 'woldvaults:pogging_seed_base',
        X: 'the_vault:echo_pog',
        E: 'woldvaults:pog_prism'
    })
